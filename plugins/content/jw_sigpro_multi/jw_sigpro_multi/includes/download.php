...
{
	$sitePath = str_replace(DS.'plugins'.DS.'content'.DS.'jw_sigpro_multi'.DS.'jw_sigpro_multi'.DS.'includes', '', dirname(__FILE__));
	$siteUrl = str_replace('/plugins/content/jw_sigpro_multi/jw_sigpro_multi/includes/', '', JURI::root());
}
else
{
	$sitePath = str_replace(DS.'plugins'.DS.'content'.DS.'jw_sigpro_multi'.DS.'includes', '', dirname(__FILE__));
	$siteUrl = str_replace('/plugins/content/jw_sigpro_multi/includes/', '', JURI::root());
}

// Load the plugin language file
$language = JFactory::getLanguage();
$language->load('plg_content_jw_sigpro_multi', JPATH_ADMINISTRATOR);
