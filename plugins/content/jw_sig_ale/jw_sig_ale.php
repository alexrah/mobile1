...
class plgContentjw_sig_ale extends JPlugin {

  // JoomlaWorks reference parameters
	var $plg_name								= "jw_sig_ale";
	var $plg_tag								= "gallery_ale";
	...
	function plgContentjw_sig_ale( &$subject, $params ){
    ...
    $mainframe = JFactory::getApplication();
		...
		if (JPluginHelper::isEnabled('content', 'jw_sig_alepro') == true)
		{
			return;
		}
